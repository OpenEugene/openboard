...
func authSwaggerJsonBytes() ([]byte, error) {
	return _authSwaggerJson, nil
}

func authSwaggerJson() (*asset, error) {
	bytes, err := authSwaggerJsonBytes()
	if err != nil {
		return nil, err
	}
...
var _userSwaggerJson = []byte(`{
  "swagger": "2.0",
  "info": {
    "title": "openboard",
    "description": "user semantics:\n\n Add{T}(s)    (Add{T}(s)Req)    returns {T}(s)Resp // POST\n Ovr{T}(s)    (Ovr{T}(s)Req)    returns {T}(s)Resp // PUT\n Mod{T}(s)    (Mod{T}(s)Req)    returns {T}(s)Resp // PATCH\n Get{T}       (Get{T}Req)       returns {T}Resp    // GET\n Fnd{T}s      (Fnd{T}sReq)      returns {T}sResp   // GET\n Rmv{T}(s)    (Rmv{T}(s)Req)    returns EmptyResp  // DELETE\n Unr{T}       (Unr{T}Req)       returns {T}Resp    // PATCH",
    "version": "version not set"
  },
  "schemes": [
    "http",
...
func userSwaggerJsonBytes() ([]byte, error) {
	return _userSwaggerJson, nil
}

func userSwaggerJson() (*asset, error) {
	bytes, err := userSwaggerJsonBytes()
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"auth.swagger.json": authSwaggerJson,
	"user.swagger.json": userSwaggerJson,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"auth.swagger.json": &bintree{authSwaggerJson, map[string]*bintree{}},
	"user.swagger.json": &bintree{userSwaggerJson, map[string]*bintree{}},
}}
