...
func _0001_setup_user_tableSqlBytes() ([]byte, error) {
	return __0001_setup_user_tableSql, nil
}

func _0001_setup_user_tableSql() (*asset, error) {
	bytes, err := _0001_setup_user_tableSqlBytes()
	if err != nil {
		return nil, err
	}
...
func _0002_setup_role_tableSqlBytes() ([]byte, error) {
	return __0002_setup_role_tableSql, nil
}

func _0002_setup_role_tableSql() (*asset, error) {
	bytes, err := _0002_setup_role_tableSqlBytes()
	if err != nil {
		return nil, err
	}
